...
class Html{
    ...
    public function render($view,$variables){
        ...
        $this->component->importComponent('Default/Head', true);
    ...
    private function injectDependences(){
        $files_array_link = ['css/font-awesome.min.css'];
        $files_array_insert = ['css/argon.min.css','css/nucleo.css','css/style.css'];
        $files_arrayjs = ['js/jquery-3.3.1.min.js','js/jquery.mask.js'];
